...
for($i = 0; $i < $count; $i++){
    ...
    echo "<tr><td>$re[0]</td><td>$re[2]</td><td>$re[3]</td><td>$re[4]</td><td>$re[5]</td><td>$re[6]</td><td><a href='update_form.php?a=$re[0]'>수정</a> <a href='delete_form.php?b=$re[0]'>삭제</a></td></tr>";
}
